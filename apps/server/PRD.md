...
{
  "token": "eyJ...",
  "user": { "id": "uuid", "email": "...", "name": "...", "role": "VET", "organizationId": "uuid" }
}
```
...
2. **Lint antes de abrir**: `npm run lint`
3. **Schema changes**: sempre acompanhar com `npx prisma migrate dev --name <desc>`
