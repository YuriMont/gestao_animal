  ...
  await app.register(swagger, {
    ...
    openapi: {
      info: {
        ...
        description: 'REST API for managing livestock — animals, health records, reproduction, production, and financials.',
        version: '1.0.0',
      },
      ...
      components: {
        securitySchemes: {
          bearerAuth: {
            ...
            scheme: 'bearer',
            bearerFormat: 'JWT',
            description: 'Obtain a token via POST /auth/login and send it as: Authorization: Bearer <token>',
          },
        },
      },
      tags: [
        ...
        { name: 'Health', description: 'Health records, vaccines and treatments' },
        { name: 'Reproduction', description: 'Estrus, pregnancies and births' },
        { name: 'Production', description: 'Weight and milk production records' },
