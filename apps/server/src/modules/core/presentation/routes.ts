...
export default async function coreRoutes(app: FastifyInstance) {
  ...
  app.get('/animals', {
    schema: {
      ...
      response: {
        200: z.object({ data: z.array(animalResponseSchema), meta: paginationMeta }),
      },
    },
  ...
  app.get('/organizations', {
    schema: {
      ...
      security: [{ bearerAuth: [] }],
      response: { 200: z.object({ data: z.array(organizationResponseSchema) }) },
    },
  ...
  app.get('/users', {
    schema: {
      ...
      response: {
        200: z.object({ data: z.array(userResponseSchema), meta: paginationMeta }),
      },
    },
  }, userController.list);
