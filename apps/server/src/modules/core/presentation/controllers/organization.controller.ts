...
import type { CreateOrganizationDTO, UpdateOrganizationDTO } from '@src/modules/core/presentation/dtos/organization.dto';
...
function safeOrg(org: any) {
  return { id: org.id, name: org.props.name, createdAt: org.props.createdAt, updatedAt: org.props.updatedAt };
}
...
export const organizationController = {
  ...
  async update(request: FastifyRequest<{ Params: { id: string }; Body: UpdateOrganizationDTO }>, reply: FastifyReply) {
    const repo = getRepo();
