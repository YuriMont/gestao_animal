...
export const financialController = {
  async create(request: FastifyRequest<{ Body: CreateFinancialRecordDTO }>, reply: FastifyReply) {
    const tenantId = request.tenantId;
    const repository = new PrismaFinancialRepository(PrismaService.getInstance());
