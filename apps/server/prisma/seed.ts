	...
	await Promise.all([
		...
		prisma.healthRecord.create({
			data: {
				...
				observation:
					"Mastite subclínica detectada, encaminhado para tratamento",
				organizationId: org.id,
			},
		}),
	]);
	...
	const financials = [
		{
			...
			category: FinancialCategory.OTHER, // Venda de leite
			amount: 4800,
			date: new Date("2025-03-31"),
			description: "Referente a março/2025",
		},
		{
			type: FinancialType.INCOME,
			category: FinancialCategory.OTHER, // Venda de leite
		...
		{
			type: FinancialType.INCOME,
			category: FinancialCategory.OTHER, // Venda de animais
			amount: 9500,
			date: new Date("2025-02-15"),
			description: "Venda de 1 garrote — SJ-010",
		},
		{
			type: FinancialType.EXPENSE,
			category: FinancialCategory.FEED,
			amount: 2300,
			date: new Date("2025-03-05"),
			description: "Compra de silagem e suplemento mineral",
		},
		{
			type: FinancialType.EXPENSE,
			category: FinancialCategory.MEDICATION,
			amount: 580,
			date: new Date("2025-01-20"),
			description: "Campanha de vacinação aftosa",
		},
		{
			type: FinancialType.EXPENSE,
			category: FinancialCategory.MEDICATION,
			...
			description: "Antibióticos e antiparasitários",
		},
		{
			type: FinancialType.EXPENSE,
			...
			amount: 3200,
			date: new Date("2025-04-30"),
			description: "Folha de pagamento — abril/2025",
		},
		{
			type: FinancialType.EXPENSE,
			...
			description: "Reparo de cercas e bebedouros",
		},
		{
			type: FinancialType.EXPENSE,
			category: FinancialCategory.OTHER, // Energia elétrica
			amount: 380,
			date: new Date("2025-04-05"),
			description: "Conta de energia — abril/2025",
		},
	];
