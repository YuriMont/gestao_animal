...
import type { PostV1FinancialRecords201, PostV1FinancialRecordsMutationRequest, PostV1FinancialRecordsMutationResponse } from "../../models/financialController/PostV1FinancialRecords.ts";
...
export function createPostV1FinancialRecordsMutationResponse(data?: Partial<PostV1FinancialRecordsMutationResponse>): PostV1FinancialRecordsMutationResponse {

  return data || faker.helpers.arrayElement<any>([createPostV1FinancialRecords201()])
}