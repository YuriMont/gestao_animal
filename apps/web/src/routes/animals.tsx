...
import type { PutV1AnimalsIdMutationRequestSexEnumKey } from "@/gen";
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className="space-y-1.5">
        ...
        <Select
          value={form.sex}
          onValueChange={(v) =>
            onChange({ ...form, sex: v as "Male" | "Female" })
          }
        >
          <SelectTrigger>
      ...
      <div className="col-span-2 space-y-1.5">
        ...
        <Select
          value={form.status}
          onValueChange={(v) =>
            onChange({ ...form, status: v as AnimalFormData["status"] })
          }
        >
          <SelectTrigger>
            <SelectValue />
...
function AnimalsPage() {
  ...
  const meta = animalsQuery.data?.data;
  ...
  function handleUpdate() {
    ...
    updateMutation.mutate({
      ...
      data: {
        ...
        sex: editAnimal.form.sex as
          | PutV1AnimalsIdMutationRequestSexEnumKey
          | undefined,
                              ...
                              onClick={() =>
                                setEditAnimal({
                                  ...
                                  form: {
                                    ...
                                    status:
                                      animal.status as AnimalFormData["status"],
                                  },
                                })
                              }
                            >
