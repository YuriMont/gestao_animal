...
function FinancialPage() {
	...
	const records =
		Array.isArray(
			recordsQuery.data || recordsQuery?.data
		) as any[]
		? (Array.isArray(recordsQuery.data) ? (recordsQuery.data as any).data : [])
		: [];
	const typeRecords = Array.isArray(recordsQuery.data)
		? (recordsQuery.data as any).data.filter((r: any) => r.type === typeFilter)
		: [];
