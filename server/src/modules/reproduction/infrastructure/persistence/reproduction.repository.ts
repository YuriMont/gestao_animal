...
export class PrismaReproductionRepository implements IReproductionRepository {
  ...
  async findPregnanciesByOrganization(organizationId: string): Promise<Pregnancy[]> {
  ...
  async findReproductionHistoryByAnimal(animalId: string, organizationId: string) {
